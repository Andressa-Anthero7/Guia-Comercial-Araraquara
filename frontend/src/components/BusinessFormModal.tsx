...
interface BusinessFormModalProps {
  onClose: () => void;
  onSubmit: (business: Omit<Business, "id" | "rating" | "reviewsCount" | "isFeatured">) => Promise<void>;
}
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-900/60 backdrop-blur-sm">
        <div className="relative w-full max-w-md rounded-3xl bg-white p-8 text-center shadow-2xl animate-scale-up">
          ...
          <p className="mt-3 text-sm text-stone-600 leading-relaxed">
            Sua empresa foi enviada para analise do Guia Comercial Araraquara.
            A publicacao sera liberada pelo backoffice do portal.
          </p>
          <p className="hidden">
