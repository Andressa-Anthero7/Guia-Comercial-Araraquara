...
**Estado atual em 10/09/2026 às 21h50 (America/Sao_Paulo): versão 2.1.1 publicada e testada.** A visão geral do anunciante ficou compacta e administrativa: banner promocional removido, indicadores no início, gestão no cabeçalho e atalhos diretos. Conferida com a SOL em 1366 × 768, 390 e 320 px. Login em `https://guiacomararaquara.com.br/anunciante/login`, painel em `/area-do-anunciante`. Consulte [Portal 2.1.1](../deployment/PORTAL-2.1.1.md).
...
- Há código do backlog salvo e ainda não publicado nem commitado: agendamento, métricas, fotos do anunciante, benefícios, recorrência, marketing, recuperação de senha e melhorias operacionais. Preservar esse trabalho; as entregas 2.0.4–2.1.1 foram montadas a partir da versão publicada, com alterações isoladas. A planilha precisa receber os resultados da execução posterior à revisão inicial.
